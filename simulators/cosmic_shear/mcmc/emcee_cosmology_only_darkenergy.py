...
Q = np.eye(6)*np.array([0.1, 0.1, 0.00015, 0.005, 0.3, 0.3])**2
...
Finv = np.loadtxt('Finv_de.dat')
x0 = [truncated_gaussian_prior_draw([prior_mean, Finv, lower, upper]) for i in range(50)]
D = 6
nwalkers = 50
...
# Save the chain
f = open('emcee_samples_darkenergy.dat', 'wb')
